...
export function OpenEyeIcon({ color = "var(--color-text)" }) {
  return (
    ...
    >
      <path
        d="M3.41978 33.421C3.07947 32.5042 3.07947 31.4958 3.41978 30.579C6.73422 22.5424 12.3603 15.6709 19.5848 10.8357C26.8092 6.00043 35.3067 3.41919 43.9999 3.41919C52.6932 3.41919 61.1907 6.00043 68.4151 10.8357C75.6396 15.6709 81.2657 22.5424 84.5801 30.579C84.9204 31.4958 84.9204 32.5042 84.5801 33.421C81.2657 41.4576 75.6396 48.3291 68.4151 53.1643C61.1907 57.9996 52.6932 60.5808 43.9999 60.5808C35.3067 60.5808 26.8092 57.9996 19.5848 53.1643C12.3603 48.3291 6.73422 41.4576 3.41978 33.421Z"
        stroke={color}
        strokeWidth="5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M43.9999 44.25C50.7654 44.25 56.2499 38.7655 56.2499 32C56.2499 25.2345 50.7654 19.75 43.9999 19.75C37.2345 19.75 31.7499 25.2345 31.7499 32C31.7499 38.7655 37.2345 44.25 43.9999 44.25Z"
        stroke={color}
        strokeWidth="5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function CloseEyeIcon({ color = "var(--color-text)" }) {
  return (
    ...
    >
      <path
        d="M58.9998 46.0001L55.8712 31.9167M2.6665 2.66675C5.90936 11.5535 11.8061 19.2283 19.5574 24.651C27.3088 30.0738 36.5399 32.9823 45.9998 32.9823C55.4597 32.9823 64.6909 30.0738 72.4423 24.651C80.1936 19.2283 86.0903 11.5535 89.3332 2.66675M80.6665 33.0001L73.1872 24.1167M11.3332 33.0001L18.8125 24.1167M32.9998 46.0001L36.1285 31.9167"
        stroke={color}
        strokeWidth="5"
        strokeLinecap="round"
        strokeLinejoin="round"
